...
function convert2katakana() 
{
	for (var i = 0; i < rosiajiHiraganaSingle.length; i++) 
	{
	console.log("Looking for %s", rosiajiHiraganaSingle[i][0]);
			document.body.innerHTML = document.body.innerHTML.replace(rosiajiHiraganaSingle[i][1], rosiajiHiraganaSingle[i][0]);
	}
}
